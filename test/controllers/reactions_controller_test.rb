...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference("Reaction.count") do
      post reactions_url, params: { reaction: { joboffer_id: @reaction.joboffer_id, kind: @reaction.kind, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { joboffer_id: @reaction.joboffer_id, kind: @reaction.kind, reaction_type: @reaction.reaction_type, user_id: @reaction.user_id } }
