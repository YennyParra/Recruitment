...
class JoboffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joboffer" do
    assert_difference("Joboffer.count") do
      post joboffers_url, params: { joboffer: { description: @joboffer.description, name: @joboffer.name } }
    end
  ...
  test "should update joboffer" do
    patch joboffer_url(@joboffer), params: { joboffer: { description: @joboffer.description, name: @joboffer.name } }
